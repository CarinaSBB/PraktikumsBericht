#!/usr/bin/env python3
"""Generate a linear regression plot for the top-3 Ptotsy peaks per year."""
...
OUTPUT_PATH = OUTPUT_DIR / "LR_top3_peaks_ab_2014.png"
...
ax.scatter(x, y, color="#E2001A", alpha=0.8, s=35, label="Top-3-Peaks")
ax.plot(line_x, line_y, color="#4D4D4D", linewidth=2.5, label=f"Lineare Regression (R²={r_squared:.3f})")

ax.set_title("Lineare Regression der Top-3-Peaks pro Jahr (2014--2025)")
ax.set_xlabel("Jahr")
